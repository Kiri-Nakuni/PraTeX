...
| `codex3/perf-integration` | 現在の統合・性能枝 | vertical discard、run-local compiled spacing dispatcher、最小横組`prjlreq`を統合。`a2765c7`で全release 915 passed / 0 failed / 11 ignored、plain DVI byte回帰成功。公式CTAN TRIPは未実施 |
