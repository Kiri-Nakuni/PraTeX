...
| | 分岐点 `36af0ee` | 本枝 | 
|---|---|---|
| 命令数 | 8,739,185,718 | **7,497,830,453**（−14.20%） |
| PraTeX wall 中央値 | — | 1.1603 s |
| upLaTeX wall 中央値 | — | 0.7934 s |
| **paired wall 比 中央値** | **1.615624**（記録値） | **1.4750** |
| paired wall 比 幾何平均 | 1.590993（記録値） | 1.4682 |
...
大きかったのは後ろの二つで、どちらも fmt 読み込みである。
